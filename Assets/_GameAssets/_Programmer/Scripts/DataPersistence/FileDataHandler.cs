...
namespace MyCampusStory.DataPersistenceSystem
{
    public class FileDataHandler
    {
        ...
        public GameData LoadFromFile(string profileId, bool allowRestoreFromBackup = true) 
        {
                ...
                catch (Exception e) 
                {
                    ...
                    if (allowRestoreFromBackup) 
                    {
                        ...
                        if (rollbackSuccess)
                        {
                            ...
                            loadedData = LoadFromFile(profileId, false);
                        }
                    }
        ...
        public void SaveToFile(GameData data, string profileId) 
        {
            // base case - if the profileId is null, return right away
            if (profileId == null) 
            {
            ...
            try 
            {
                ...
                GameData verifiedGameData = LoadFromFile(profileId);
        ...
        public Dictionary<string, GameData> LoadAllProfiles() 
        {
            ...
            foreach (DirectoryInfo dirInfo in dirInfos) 
            {
                ...
                GameData profileData = LoadFromFile(profileId);
